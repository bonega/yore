...
impl DecoderIncomplete for CP857 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = unsafe {
        [
            ...
            Some(([0xC3, 0xA0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xA5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xA7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xAA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xAB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xA8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xAF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xAE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC4, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0xB2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xBB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xB9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC4, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x91, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC4, 0x9E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC4, 0x9F, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0x80, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x83, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC2, 0xBA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xAA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x8A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x8B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x88, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            Some(([0xC3, 0x8D, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x8E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x8F, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0x8C, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0x92, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0x9B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x99, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xAC, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xBF, 0x0], NonZeroU8::new_unchecked(2))),
