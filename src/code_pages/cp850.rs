...
impl CP850 {
    ...
    ///
    /// Allocation-free, so available without the `alloc` feature. CP850
    ...
    /// Encode a single Unicode `char` into its CP850 byte.
    ///
...
const DECODE_TABLE: decoder::complete::Table = [
    ...
    Entry::new([0xC3, 0xB0, 0x00], 2),
    Entry::new([0xC3, 0x90, 0x00], 2),
    ...
    Entry::new([0xC3, 0xBE, 0x00], 2),
    Entry::new([0xC3, 0x9E, 0x00], 2),
