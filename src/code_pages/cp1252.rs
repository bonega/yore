...
impl CP1252 {
    ...
    ///
    /// assert_eq!(CP1252.decode(&[116, 101, 120, 116]).unwrap(), "text");
    /// ```
    #[inline(always)]
    ...
    /// use yore::code_pages::CP1252;
    ///
    /// assert_eq!(CP1252.decode_lossy(&[116, 101, 120, 116]), "text");
    /// ```
    #[inline(always)]
    ...
    /// use yore::code_pages::CP1252;
    ///
    /// assert_eq!(CP1252.decode_lossy_fallback(&[116, 101, 120, 116], '�'), "text");
    /// ```
    #[inline(always)]
...
impl DecoderIncomplete for CP1252 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = unsafe {
        [
            ...
            Some(([0xC5, 0x92, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            ...
            Some(([0xC5, 0x93, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            Some(([0xC5, 0xBE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC5, 0xB8, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0x90, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0x9E, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC3, 0xBE, 0x0], NonZeroU8::new_unchecked(2))),
