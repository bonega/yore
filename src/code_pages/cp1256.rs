...
impl CP1256 {
    ...
    ///
    /// Allocation-free, so available without the `alloc` feature. CP1256
    ...
    /// Encode a single Unicode `char` into its CP1256 byte.
    ///
...
const DECODE_TABLE: decoder::complete::Table = [
    ...
    Entry::new([0xD9, 0xB9, 0x00], 2),
    Entry::new([0xE2, 0x80, 0xB9], 3),
    Entry::new([0xC5, 0x92, 0x00], 2),
    Entry::new([0xDA, 0x86, 0x00], 2),
    Entry::new([0xDA, 0x98, 0x00], 2),
    Entry::new([0xDA, 0x88, 0x00], 2),
    Entry::new([0xDA, 0xAF, 0x00], 2),
    ...
    Entry::new([0xDA, 0xA9, 0x00], 2),
    Entry::new([0xE2, 0x84, 0xA2], 3),
    Entry::new([0xDA, 0x91, 0x00], 2),
    Entry::new([0xE2, 0x80, 0xBA], 3),
    Entry::new([0xC5, 0x93, 0x00], 2),
    Entry::new([0xE2, 0x80, 0x8C], 3),
    Entry::new([0xE2, 0x80, 0x8D], 3),
    Entry::new([0xDA, 0xBA, 0x00], 2),
    ...
    Entry::new([0xDB, 0x81, 0x00], 2),
    Entry::new([0xD8, 0xA1, 0x00], 2),
    Entry::new([0xD8, 0xA2, 0x00], 2),
    Entry::new([0xD8, 0xA3, 0x00], 2),
    Entry::new([0xD8, 0xA4, 0x00], 2),
    Entry::new([0xD8, 0xA5, 0x00], 2),
    Entry::new([0xD8, 0xA6, 0x00], 2),
    Entry::new([0xD8, 0xA7, 0x00], 2),
    Entry::new([0xD8, 0xA8, 0x00], 2),
    Entry::new([0xD8, 0xA9, 0x00], 2),
    Entry::new([0xD8, 0xAA, 0x00], 2),
    Entry::new([0xD8, 0xAB, 0x00], 2),
    Entry::new([0xD8, 0xAC, 0x00], 2),
    Entry::new([0xD8, 0xAD, 0x00], 2),
    Entry::new([0xD8, 0xAE, 0x00], 2),
    Entry::new([0xD8, 0xAF, 0x00], 2),
    Entry::new([0xD8, 0xB0, 0x00], 2),
    Entry::new([0xD8, 0xB1, 0x00], 2),
    Entry::new([0xD8, 0xB2, 0x00], 2),
    Entry::new([0xD8, 0xB3, 0x00], 2),
    Entry::new([0xD8, 0xB4, 0x00], 2),
    Entry::new([0xD8, 0xB5, 0x00], 2),
    Entry::new([0xD8, 0xB6, 0x00], 2),
    Entry::new([0xC3, 0x97, 0x00], 2),
    Entry::new([0xD8, 0xB7, 0x00], 2),
    Entry::new([0xD8, 0xB8, 0x00], 2),
    Entry::new([0xD8, 0xB9, 0x00], 2),
    Entry::new([0xD8, 0xBA, 0x00], 2),
    Entry::new([0xD9, 0x80, 0x00], 2),
    Entry::new([0xD9, 0x81, 0x00], 2),
    Entry::new([0xD9, 0x82, 0x00], 2),
    Entry::new([0xD9, 0x83, 0x00], 2),
    Entry::new([0xC3, 0xA0, 0x00], 2),
    Entry::new([0xD9, 0x84, 0x00], 2),
    Entry::new([0xC3, 0xA2, 0x00], 2),
    Entry::new([0xD9, 0x85, 0x00], 2),
    Entry::new([0xD9, 0x86, 0x00], 2),
    Entry::new([0xD9, 0x87, 0x00], 2),
    Entry::new([0xD9, 0x88, 0x00], 2),
    ...
    Entry::new([0xD9, 0x89, 0x00], 2),
    Entry::new([0xD9, 0x8A, 0x00], 2),
    Entry::new([0xC3, 0xAE, 0x00], 2),
    Entry::new([0xC3, 0xAF, 0x00], 2),
    Entry::new([0xD9, 0x8B, 0x00], 2),
    Entry::new([0xD9, 0x8C, 0x00], 2),
    Entry::new([0xD9, 0x8D, 0x00], 2),
    Entry::new([0xD9, 0x8E, 0x00], 2),
    Entry::new([0xC3, 0xB4, 0x00], 2),
    Entry::new([0xD9, 0x8F, 0x00], 2),
    Entry::new([0xD9, 0x90, 0x00], 2),
    Entry::new([0xC3, 0xB7, 0x00], 2),
    Entry::new([0xD9, 0x91, 0x00], 2),
    Entry::new([0xC3, 0xB9, 0x00], 2),
    Entry::new([0xD9, 0x92, 0x00], 2),
    Entry::new([0xC3, 0xBB, 0x00], 2),
    Entry::new([0xC3, 0xBC, 0x00], 2),
    Entry::new([0xE2, 0x80, 0x8E], 3),
    Entry::new([0xE2, 0x80, 0x8F], 3),
    Entry::new([0xDB, 0x92, 0x00], 2),
];
