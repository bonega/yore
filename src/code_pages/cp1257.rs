...
impl CP1257 {
    ...
    /// Encode a single Unicode `char` into its CP1257 byte.
    ///
...
const DECODE_TABLE: decoder::incomplete::Table = [
    ...
    Some(Entry::new([0xCB, 0x87, 0x00], 2)),
    ...
    Some(Entry::new([0xCB, 0x9B, 0x00], 2)),
    ...
    Some(Entry::new([0xC5, 0x96, 0x00], 2)),
    ...
    Some(Entry::new([0xC5, 0x97, 0x00], 2)),
    ...
    Some(Entry::new([0xC4, 0x84, 0x00], 2)),
    Some(Entry::new([0xC4, 0xAE, 0x00], 2)),
    Some(Entry::new([0xC4, 0x80, 0x00], 2)),
    Some(Entry::new([0xC4, 0x86, 0x00], 2)),
    Some(Entry::new([0xC3, 0x84, 0x00], 2)),
    Some(Entry::new([0xC3, 0x85, 0x00], 2)),
    Some(Entry::new([0xC4, 0x98, 0x00], 2)),
    Some(Entry::new([0xC4, 0x92, 0x00], 2)),
    Some(Entry::new([0xC4, 0x8C, 0x00], 2)),
    Some(Entry::new([0xC3, 0x89, 0x00], 2)),
    Some(Entry::new([0xC5, 0xB9, 0x00], 2)),
    Some(Entry::new([0xC4, 0x96, 0x00], 2)),
    Some(Entry::new([0xC4, 0xA2, 0x00], 2)),
    Some(Entry::new([0xC4, 0xB6, 0x00], 2)),
    Some(Entry::new([0xC4, 0xAA, 0x00], 2)),
    Some(Entry::new([0xC4, 0xBB, 0x00], 2)),
    Some(Entry::new([0xC5, 0xA0, 0x00], 2)),
    Some(Entry::new([0xC5, 0x83, 0x00], 2)),
    Some(Entry::new([0xC5, 0x85, 0x00], 2)),
    Some(Entry::new([0xC3, 0x93, 0x00], 2)),
    Some(Entry::new([0xC5, 0x8C, 0x00], 2)),
    Some(Entry::new([0xC3, 0x95, 0x00], 2)),
    Some(Entry::new([0xC3, 0x96, 0x00], 2)),
    Some(Entry::new([0xC3, 0x97, 0x00], 2)),
    Some(Entry::new([0xC5, 0xB2, 0x00], 2)),
    Some(Entry::new([0xC5, 0x81, 0x00], 2)),
    Some(Entry::new([0xC5, 0x9A, 0x00], 2)),
    Some(Entry::new([0xC5, 0xAA, 0x00], 2)),
    Some(Entry::new([0xC3, 0x9C, 0x00], 2)),
    Some(Entry::new([0xC5, 0xBB, 0x00], 2)),
    Some(Entry::new([0xC5, 0xBD, 0x00], 2)),
    Some(Entry::new([0xC3, 0x9F, 0x00], 2)),
    Some(Entry::new([0xC4, 0x85, 0x00], 2)),
    Some(Entry::new([0xC4, 0xAF, 0x00], 2)),
    Some(Entry::new([0xC4, 0x81, 0x00], 2)),
    Some(Entry::new([0xC4, 0x87, 0x00], 2)),
    Some(Entry::new([0xC3, 0xA4, 0x00], 2)),
    Some(Entry::new([0xC3, 0xA5, 0x00], 2)),
    Some(Entry::new([0xC4, 0x99, 0x00], 2)),
    Some(Entry::new([0xC4, 0x93, 0x00], 2)),
    Some(Entry::new([0xC4, 0x8D, 0x00], 2)),
    Some(Entry::new([0xC3, 0xA9, 0x00], 2)),
    Some(Entry::new([0xC5, 0xBA, 0x00], 2)),
    Some(Entry::new([0xC4, 0x97, 0x00], 2)),
    Some(Entry::new([0xC4, 0xA3, 0x00], 2)),
    Some(Entry::new([0xC4, 0xB7, 0x00], 2)),
    Some(Entry::new([0xC4, 0xAB, 0x00], 2)),
    Some(Entry::new([0xC4, 0xBC, 0x00], 2)),
    Some(Entry::new([0xC5, 0xA1, 0x00], 2)),
    Some(Entry::new([0xC5, 0x84, 0x00], 2)),
    Some(Entry::new([0xC5, 0x86, 0x00], 2)),
    Some(Entry::new([0xC3, 0xB3, 0x00], 2)),
    Some(Entry::new([0xC5, 0x8D, 0x00], 2)),
    Some(Entry::new([0xC3, 0xB5, 0x00], 2)),
    Some(Entry::new([0xC3, 0xB6, 0x00], 2)),
    Some(Entry::new([0xC3, 0xB7, 0x00], 2)),
    Some(Entry::new([0xC5, 0xB3, 0x00], 2)),
    Some(Entry::new([0xC5, 0x82, 0x00], 2)),
    Some(Entry::new([0xC5, 0x9B, 0x00], 2)),
    Some(Entry::new([0xC5, 0xAB, 0x00], 2)),
    Some(Entry::new([0xC3, 0xBC, 0x00], 2)),
    Some(Entry::new([0xC5, 0xBC, 0x00], 2)),
    Some(Entry::new([0xC5, 0xBE, 0x00], 2)),
    Some(Entry::new([0xCB, 0x99, 0x00], 2)),
];
#[cfg(feature = "alloc")]
const DECODE_TABLE_LOSSY: decoder::complete::Table = [
    ...
    Entry::new([0xC4, 0x84, 0x00], 2),
    Entry::new([0xC4, 0xAE, 0x00], 2),
    Entry::new([0xC4, 0x80, 0x00], 2),
    Entry::new([0xC4, 0x86, 0x00], 2),
    Entry::new([0xC3, 0x84, 0x00], 2),
    Entry::new([0xC3, 0x85, 0x00], 2),
    Entry::new([0xC4, 0x98, 0x00], 2),
    Entry::new([0xC4, 0x92, 0x00], 2),
    Entry::new([0xC4, 0x8C, 0x00], 2),
    Entry::new([0xC3, 0x89, 0x00], 2),
    Entry::new([0xC5, 0xB9, 0x00], 2),
    Entry::new([0xC4, 0x96, 0x00], 2),
    Entry::new([0xC4, 0xA2, 0x00], 2),
    Entry::new([0xC4, 0xB6, 0x00], 2),
    Entry::new([0xC4, 0xAA, 0x00], 2),
    Entry::new([0xC4, 0xBB, 0x00], 2),
    Entry::new([0xC5, 0xA0, 0x00], 2),
    Entry::new([0xC5, 0x83, 0x00], 2),
    Entry::new([0xC5, 0x85, 0x00], 2),
    Entry::new([0xC3, 0x93, 0x00], 2),
    Entry::new([0xC5, 0x8C, 0x00], 2),
    Entry::new([0xC3, 0x95, 0x00], 2),
    Entry::new([0xC3, 0x96, 0x00], 2),
    Entry::new([0xC3, 0x97, 0x00], 2),
    Entry::new([0xC5, 0xB2, 0x00], 2),
    Entry::new([0xC5, 0x81, 0x00], 2),
    Entry::new([0xC5, 0x9A, 0x00], 2),
    Entry::new([0xC5, 0xAA, 0x00], 2),
    Entry::new([0xC3, 0x9C, 0x00], 2),
    Entry::new([0xC5, 0xBB, 0x00], 2),
    Entry::new([0xC5, 0xBD, 0x00], 2),
    Entry::new([0xC3, 0x9F, 0x00], 2),
    Entry::new([0xC4, 0x85, 0x00], 2),
    Entry::new([0xC4, 0xAF, 0x00], 2),
    Entry::new([0xC4, 0x81, 0x00], 2),
    Entry::new([0xC4, 0x87, 0x00], 2),
    Entry::new([0xC3, 0xA4, 0x00], 2),
    Entry::new([0xC3, 0xA5, 0x00], 2),
    Entry::new([0xC4, 0x99, 0x00], 2),
    Entry::new([0xC4, 0x93, 0x00], 2),
    Entry::new([0xC4, 0x8D, 0x00], 2),
    Entry::new([0xC3, 0xA9, 0x00], 2),
    Entry::new([0xC5, 0xBA, 0x00], 2),
    Entry::new([0xC4, 0x97, 0x00], 2),
    Entry::new([0xC4, 0xA3, 0x00], 2),
    Entry::new([0xC4, 0xB7, 0x00], 2),
    Entry::new([0xC4, 0xAB, 0x00], 2),
    Entry::new([0xC4, 0xBC, 0x00], 2),
    Entry::new([0xC5, 0xA1, 0x00], 2),
    Entry::new([0xC5, 0x84, 0x00], 2),
    Entry::new([0xC5, 0x86, 0x00], 2),
    Entry::new([0xC3, 0xB3, 0x00], 2),
    Entry::new([0xC5, 0x8D, 0x00], 2),
    Entry::new([0xC3, 0xB5, 0x00], 2),
    Entry::new([0xC3, 0xB6, 0x00], 2),
    Entry::new([0xC3, 0xB7, 0x00], 2),
    Entry::new([0xC5, 0xB3, 0x00], 2),
    Entry::new([0xC5, 0x82, 0x00], 2),
    Entry::new([0xC5, 0x9B, 0x00], 2),
    Entry::new([0xC5, 0xAB, 0x00], 2),
    Entry::new([0xC3, 0xBC, 0x00], 2),
    Entry::new([0xC5, 0xBC, 0x00], 2),
    Entry::new([0xC5, 0xBE, 0x00], 2),
    Entry::new([0xCB, 0x99, 0x00], 2),
];
