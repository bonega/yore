...
impl CP1251 {
    ...
    ///
    /// assert_eq!(CP1251.decode(&[116, 101, 120, 116]).unwrap(), "text");
    /// ```
    #[inline(always)]
    ...
    /// use yore::code_pages::CP1251;
    ///
    /// assert_eq!(CP1251.decode_lossy(&[116, 101, 120, 116]), "text");
    /// ```
    #[inline(always)]
    ...
    /// use yore::code_pages::CP1251;
    ///
    /// assert_eq!(CP1251.decode_lossy_fallback(&[116, 101, 120, 116], '�'), "text");
    /// ```
    #[inline(always)]
...
impl DecoderIncomplete for CP1251 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = unsafe {
        [
            ...
            Some(([0xD0, 0x82, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x83, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x80, 0x9A], NonZeroU8::new_unchecked(3))),
            Some(([0xD1, 0x93, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xD0, 0x89, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x80, 0xB9], NonZeroU8::new_unchecked(3))),
            Some(([0xD0, 0x8A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x8C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x8B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x8F, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x92, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xD1, 0x99, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x80, 0xBA], NonZeroU8::new_unchecked(3))),
            Some(([0xD1, 0x9A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x9C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x9B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x9F, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x8E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x9E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x88, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD2, 0x90, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x81, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x84, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xD0, 0x87, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x86, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x96, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD2, 0x91, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xD1, 0x91, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x84, 0x96], NonZeroU8::new_unchecked(3))),
            Some(([0xD1, 0x94, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xBB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x98, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x85, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x95, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x97, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x90, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x91, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x92, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x93, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x94, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x95, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x96, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x97, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x98, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x99, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x9A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x9B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x9C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x9D, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x9E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0x9F, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xA9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xAA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xAB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xAC, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xAD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xAE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xAF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xB9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xBA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xBB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xBC, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xBD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xBE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD0, 0xBF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x80, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x81, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x82, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x83, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x84, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x85, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x86, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x87, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x88, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x89, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x8A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x8B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x8C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x8D, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x8E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD1, 0x8F, 0x0], NonZeroU8::new_unchecked(2))),
        ]
    };
}
