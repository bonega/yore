...
impl DecoderIncomplete for CP1255 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = unsafe {
        [
            ...
            Some(([0xCB, 0x86, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xCB, 0x9C, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC2, 0xA1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x82, 0xAA], NonZeroU8::new_unchecked(3))),
            ...
            Some(([0xC2, 0xBF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xB9, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            Some(([0xD6, 0xBB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xBC, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xBD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xBE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD6, 0xBF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x80, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x81, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x82, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x83, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xB2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xB3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xB4, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            None,
            None,
            None,
            ...
            None,
            None,
            Some(([0xD7, 0x90, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x91, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x92, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x93, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x94, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x95, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x96, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x97, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x98, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x99, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x9A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x9B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x9C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x9D, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x9E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0x9F, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xA9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xD7, 0xAA, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            None,
            Some(([0xE2, 0x80, 0x8E], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x80, 0x8F], NonZeroU8::new_unchecked(3))),
            None,
        ]
    };
}
