...
impl CP1255 {
    ...
    /// Encode a single Unicode `char` into its CP1255 byte.
    ///
...
const DECODE_TABLE: decoder::incomplete::Table = [
    ...
    Some(Entry::new([0xCB, 0x86, 0x00], 2)),
    ...
    Some(Entry::new([0xCB, 0x9C, 0x00], 2)),
    ...
    Some(Entry::new([0xE2, 0x82, 0xAA], 3)),
    ...
    Some(Entry::new([0xD6, 0xB0, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB1, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB2, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB3, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB4, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB5, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB6, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB7, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB8, 0x00], 2)),
    Some(Entry::new([0xD6, 0xB9, 0x00], 2)),
    Some(Entry::new([0xD6, 0xBA, 0x00], 2)),
    Some(Entry::new([0xD6, 0xBB, 0x00], 2)),
    Some(Entry::new([0xD6, 0xBC, 0x00], 2)),
    Some(Entry::new([0xD6, 0xBD, 0x00], 2)),
    Some(Entry::new([0xD6, 0xBE, 0x00], 2)),
    Some(Entry::new([0xD6, 0xBF, 0x00], 2)),
    Some(Entry::new([0xD7, 0x80, 0x00], 2)),
    Some(Entry::new([0xD7, 0x81, 0x00], 2)),
    Some(Entry::new([0xD7, 0x82, 0x00], 2)),
    Some(Entry::new([0xD7, 0x83, 0x00], 2)),
    Some(Entry::new([0xD7, 0xB0, 0x00], 2)),
    Some(Entry::new([0xD7, 0xB1, 0x00], 2)),
    Some(Entry::new([0xD7, 0xB2, 0x00], 2)),
    Some(Entry::new([0xD7, 0xB3, 0x00], 2)),
    Some(Entry::new([0xD7, 0xB4, 0x00], 2)),
    None,
    None,
    None,
    None,
    ...
    None,
    None,
    Some(Entry::new([0xD7, 0x90, 0x00], 2)),
    Some(Entry::new([0xD7, 0x91, 0x00], 2)),
    Some(Entry::new([0xD7, 0x92, 0x00], 2)),
    Some(Entry::new([0xD7, 0x93, 0x00], 2)),
    Some(Entry::new([0xD7, 0x94, 0x00], 2)),
    Some(Entry::new([0xD7, 0x95, 0x00], 2)),
    Some(Entry::new([0xD7, 0x96, 0x00], 2)),
    Some(Entry::new([0xD7, 0x97, 0x00], 2)),
    Some(Entry::new([0xD7, 0x98, 0x00], 2)),
    Some(Entry::new([0xD7, 0x99, 0x00], 2)),
    Some(Entry::new([0xD7, 0x9A, 0x00], 2)),
    Some(Entry::new([0xD7, 0x9B, 0x00], 2)),
    Some(Entry::new([0xD7, 0x9C, 0x00], 2)),
    Some(Entry::new([0xD7, 0x9D, 0x00], 2)),
    Some(Entry::new([0xD7, 0x9E, 0x00], 2)),
    Some(Entry::new([0xD7, 0x9F, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA0, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA1, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA2, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA3, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA4, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA5, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA6, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA7, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA8, 0x00], 2)),
    Some(Entry::new([0xD7, 0xA9, 0x00], 2)),
    Some(Entry::new([0xD7, 0xAA, 0x00], 2)),
    None,
    None,
    Some(Entry::new([0xE2, 0x80, 0x8E], 3)),
    Some(Entry::new([0xE2, 0x80, 0x8F], 3)),
    None,
];
#[cfg(feature = "alloc")]
const DECODE_TABLE_LOSSY: decoder::complete::Table = [
    ...
    Entry::new([0xD6, 0xB0, 0x00], 2),
    Entry::new([0xD6, 0xB1, 0x00], 2),
    Entry::new([0xD6, 0xB2, 0x00], 2),
    Entry::new([0xD6, 0xB3, 0x00], 2),
    Entry::new([0xD6, 0xB4, 0x00], 2),
    Entry::new([0xD6, 0xB5, 0x00], 2),
    Entry::new([0xD6, 0xB6, 0x00], 2),
    Entry::new([0xD6, 0xB7, 0x00], 2),
    Entry::new([0xD6, 0xB8, 0x00], 2),
    Entry::new([0xD6, 0xB9, 0x00], 2),
    Entry::new([0xD6, 0xBA, 0x00], 2),
    Entry::new([0xD6, 0xBB, 0x00], 2),
    Entry::new([0xD6, 0xBC, 0x00], 2),
    Entry::new([0xD6, 0xBD, 0x00], 2),
    Entry::new([0xD6, 0xBE, 0x00], 2),
    Entry::new([0xD6, 0xBF, 0x00], 2),
    Entry::new([0xD7, 0x80, 0x00], 2),
    Entry::new([0xD7, 0x81, 0x00], 2),
    Entry::new([0xD7, 0x82, 0x00], 2),
    Entry::new([0xD7, 0x83, 0x00], 2),
    Entry::new([0xD7, 0xB0, 0x00], 2),
    Entry::new([0xD7, 0xB1, 0x00], 2),
    Entry::new([0xD7, 0xB2, 0x00], 2),
    Entry::new([0xD7, 0xB3, 0x00], 2),
    Entry::new([0xD7, 0xB4, 0x00], 2),
    ...
    Entry::new([0xEF, 0xBF, 0xBD], 3),
    Entry::new([0xEF, 0xBF, 0xBD], 3),
    Entry::new([0xD7, 0x90, 0x00], 2),
    Entry::new([0xD7, 0x91, 0x00], 2),
    Entry::new([0xD7, 0x92, 0x00], 2),
    Entry::new([0xD7, 0x93, 0x00], 2),
    Entry::new([0xD7, 0x94, 0x00], 2),
    Entry::new([0xD7, 0x95, 0x00], 2),
    Entry::new([0xD7, 0x96, 0x00], 2),
    Entry::new([0xD7, 0x97, 0x00], 2),
    Entry::new([0xD7, 0x98, 0x00], 2),
    Entry::new([0xD7, 0x99, 0x00], 2),
    Entry::new([0xD7, 0x9A, 0x00], 2),
    Entry::new([0xD7, 0x9B, 0x00], 2),
    Entry::new([0xD7, 0x9C, 0x00], 2),
    Entry::new([0xD7, 0x9D, 0x00], 2),
    Entry::new([0xD7, 0x9E, 0x00], 2),
    Entry::new([0xD7, 0x9F, 0x00], 2),
    Entry::new([0xD7, 0xA0, 0x00], 2),
    Entry::new([0xD7, 0xA1, 0x00], 2),
    Entry::new([0xD7, 0xA2, 0x00], 2),
    Entry::new([0xD7, 0xA3, 0x00], 2),
    Entry::new([0xD7, 0xA4, 0x00], 2),
    Entry::new([0xD7, 0xA5, 0x00], 2),
    Entry::new([0xD7, 0xA6, 0x00], 2),
    Entry::new([0xD7, 0xA7, 0x00], 2),
    Entry::new([0xD7, 0xA8, 0x00], 2),
    Entry::new([0xD7, 0xA9, 0x00], 2),
    Entry::new([0xD7, 0xAA, 0x00], 2),
    Entry::new([0xEF, 0xBF, 0xBD], 3),
    Entry::new([0xEF, 0xBF, 0xBD], 3),
    Entry::new([0xE2, 0x80, 0x8E], 3),
    Entry::new([0xE2, 0x80, 0x8F], 3),
    Entry::new([0xEF, 0xBF, 0xBD], 3),
];
