...
impl CP910 {
    ...
    ///
    /// Allocation-free, so available without the `alloc` feature. CP910
    ...
    /// Encode a single Unicode `char` into its CP910 byte.
    ///
...
const DECODE_TABLE: decoder::complete::Table = [
    ...
    Entry::new([0xE2, 0x8E, 0x95], 3),
    Entry::new([0xE2, 0x8D, 0x9E], 3),
    Entry::new([0xE2, 0x8C, 0xB9], 3),
    ...
    Entry::new([0xE2, 0x8C, 0x88], 3),
    Entry::new([0xC2, 0xAC, 0x00], 2),
    Entry::new([0xC2, 0xBD, 0x00], 2),
    Entry::new([0xE2, 0x88, 0xAA], 3),
    Entry::new([0xC2, 0xA1, 0x00], 2),
    Entry::new([0xE2, 0x8D, 0x95], 3),
    Entry::new([0xE2, 0x8D, 0x8E], 3),
    ...
    Entry::new([0xE2, 0x8D, 0x9F], 3),
    Entry::new([0xE2, 0x88, 0x86], 3),
    Entry::new([0xE2, 0x88, 0x87], 3),
    Entry::new([0xE2, 0x86, 0x92], 3),
    ...
    Entry::new([0xE2, 0x8D, 0xB8], 3),
    Entry::new([0xE2, 0x8D, 0xB7], 3),
    Entry::new([0xE2, 0x88, 0xB5], 3),
    Entry::new([0xE2, 0x8C, 0xB7], 3),
    Entry::new([0xE2, 0x8D, 0x82], 3),
    Entry::new([0xE2, 0x8C, 0xBB], 3),
    Entry::new([0xE2, 0x8A, 0xA2], 3),
    Entry::new([0xE2, 0x8A, 0xA3], 3),
    Entry::new([0xE2, 0x8B, 0x84], 3),
    ...
    Entry::new([0xE2, 0x8D, 0xBA], 3),
    Entry::new([0xC3, 0x9F, 0x00], 2),
    Entry::new([0xE2, 0x8A, 0x82], 3),
    Entry::new([0xE2, 0x8A, 0x83], 3),
    Entry::new([0xE2, 0x8D, 0x9D], 3),
    Entry::new([0xE2, 0x8D, 0xB2], 3),
    Entry::new([0xE2, 0x8D, 0xB4], 3),
    Entry::new([0xE2, 0x8D, 0xB1], 3),
    Entry::new([0xE2, 0x8C, 0xBD], 3),
    Entry::new([0xE2, 0x8A, 0x96], 3),
    Entry::new([0xE2, 0x97, 0x8B], 3),
    Entry::new([0xE2, 0x88, 0xA8], 3),
    Entry::new([0xE2, 0x8D, 0xB3], 3),
    Entry::new([0xE2, 0x8D, 0x89], 3),
    Entry::new([0xE2, 0x88, 0x8A], 3),
    Entry::new([0xE2, 0x88, 0xA9], 3),
    Entry::new([0xE2, 0x8C, 0xBF], 3),
    Entry::new([0xE2, 0x8D, 0x80], 3),
    Entry::new([0xE2, 0x89, 0xA5], 3),
    Entry::new([0xE2, 0x89, 0xA4], 3),
    Entry::new([0xE2, 0x89, 0xA0], 3),
    Entry::new([0xC3, 0x97, 0x00], 2),
    Entry::new([0xC3, 0xB7, 0x00], 2),
    Entry::new([0xE2, 0x8D, 0x99], 3),
    Entry::new([0xE2, 0x88, 0x98], 3),
    Entry::new([0xE2, 0x8D, 0xB5], 3),
    Entry::new([0xE2, 0x8D, 0xAB], 3),
    Entry::new([0xE2, 0x8D, 0x8B], 3),
    Entry::new([0xE2, 0x8D, 0x92], 3),
    Entry::new([0xE2, 0x80, 0xBE], 3),
