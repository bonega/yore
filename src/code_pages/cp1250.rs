...
impl DecoderIncomplete for CP1250 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = [
        ...
        Some(([0xC5, 0xA0, 0x0], NZ_TWO)),
        Some(([0xE2, 0x80, 0xB9], NZ_THREE)),
        Some(([0xC5, 0x9A, 0x0], NZ_TWO)),
        Some(([0xC5, 0xA4, 0x0], NZ_TWO)),
        Some(([0xC5, 0xBD, 0x0], NZ_TWO)),
        Some(([0xC5, 0xB9, 0x0], NZ_TWO)),
        None,
        ...
        Some(([0xC5, 0xA1, 0x0], NZ_TWO)),
        Some(([0xE2, 0x80, 0xBA], NZ_THREE)),
        Some(([0xC5, 0x9B, 0x0], NZ_TWO)),
        Some(([0xC5, 0xA5, 0x0], NZ_TWO)),
        Some(([0xC5, 0xBE, 0x0], NZ_TWO)),
        Some(([0xC5, 0xBA, 0x0], NZ_TWO)),
        Some(([0xC2, 0xA0, 0x0], NZ_TWO)),
        Some(([0xCB, 0x87, 0x0], NZ_TWO)),
        Some(([0xCB, 0x98, 0x0], NZ_TWO)),
        Some(([0xC5, 0x81, 0x0], NZ_TWO)),
        Some(([0xC2, 0xA4, 0x0], NZ_TWO)),
        Some(([0xC4, 0x84, 0x0], NZ_TWO)),
        ...
        Some(([0xC5, 0xBB, 0x0], NZ_TWO)),
        Some(([0xC2, 0xB0, 0x0], NZ_TWO)),
        Some(([0xC2, 0xB1, 0x0], NZ_TWO)),
        Some(([0xCB, 0x9B, 0x0], NZ_TWO)),
        Some(([0xC5, 0x82, 0x0], NZ_TWO)),
        ...
        Some(([0xC4, 0x85, 0x0], NZ_TWO)),
        Some(([0xC5, 0x9F, 0x0], NZ_TWO)),
        Some(([0xC2, 0xBB, 0x0], NZ_TWO)),
        Some(([0xC4, 0xBD, 0x0], NZ_TWO)),
        Some(([0xCB, 0x9D, 0x0], NZ_TWO)),
        Some(([0xC4, 0xBE, 0x0], NZ_TWO)),
        Some(([0xC5, 0xBC, 0x0], NZ_TWO)),
        Some(([0xC5, 0x94, 0x0], NZ_TWO)),
        Some(([0xC3, 0x81, 0x0], NZ_TWO)),
        Some(([0xC3, 0x82, 0x0], NZ_TWO)),
        Some(([0xC4, 0x82, 0x0], NZ_TWO)),
        Some(([0xC3, 0x84, 0x0], NZ_TWO)),
        Some(([0xC4, 0xB9, 0x0], NZ_TWO)),
        Some(([0xC4, 0x86, 0x0], NZ_TWO)),
        Some(([0xC3, 0x87, 0x0], NZ_TWO)),
        Some(([0xC4, 0x8C, 0x0], NZ_TWO)),
        Some(([0xC3, 0x89, 0x0], NZ_TWO)),
        Some(([0xC4, 0x98, 0x0], NZ_TWO)),
        Some(([0xC3, 0x8B, 0x0], NZ_TWO)),
        Some(([0xC4, 0x9A, 0x0], NZ_TWO)),
        Some(([0xC3, 0x8D, 0x0], NZ_TWO)),
        Some(([0xC3, 0x8E, 0x0], NZ_TWO)),
        Some(([0xC4, 0x8E, 0x0], NZ_TWO)),
        Some(([0xC4, 0x90, 0x0], NZ_TWO)),
        Some(([0xC5, 0x83, 0x0], NZ_TWO)),
        Some(([0xC5, 0x87, 0x0], NZ_TWO)),
        Some(([0xC3, 0x93, 0x0], NZ_TWO)),
        Some(([0xC3, 0x94, 0x0], NZ_TWO)),
        Some(([0xC5, 0x90, 0x0], NZ_TWO)),
        Some(([0xC3, 0x96, 0x0], NZ_TWO)),
        Some(([0xC3, 0x97, 0x0], NZ_TWO)),
        Some(([0xC5, 0x98, 0x0], NZ_TWO)),
        Some(([0xC5, 0xAE, 0x0], NZ_TWO)),
        Some(([0xC3, 0x9A, 0x0], NZ_TWO)),
        Some(([0xC5, 0xB0, 0x0], NZ_TWO)),
        Some(([0xC3, 0x9C, 0x0], NZ_TWO)),
        Some(([0xC3, 0x9D, 0x0], NZ_TWO)),
        Some(([0xC5, 0xA2, 0x0], NZ_TWO)),
        Some(([0xC3, 0x9F, 0x0], NZ_TWO)),
        Some(([0xC5, 0x95, 0x0], NZ_TWO)),
        Some(([0xC3, 0xA1, 0x0], NZ_TWO)),
        Some(([0xC3, 0xA2, 0x0], NZ_TWO)),
        Some(([0xC4, 0x83, 0x0], NZ_TWO)),
        Some(([0xC3, 0xA4, 0x0], NZ_TWO)),
        Some(([0xC4, 0xBA, 0x0], NZ_TWO)),
        Some(([0xC4, 0x87, 0x0], NZ_TWO)),
        Some(([0xC3, 0xA7, 0x0], NZ_TWO)),
        Some(([0xC4, 0x8D, 0x0], NZ_TWO)),
        Some(([0xC3, 0xA9, 0x0], NZ_TWO)),
        Some(([0xC4, 0x99, 0x0], NZ_TWO)),
        Some(([0xC3, 0xAB, 0x0], NZ_TWO)),
        Some(([0xC4, 0x9B, 0x0], NZ_TWO)),
        Some(([0xC3, 0xAD, 0x0], NZ_TWO)),
        Some(([0xC3, 0xAE, 0x0], NZ_TWO)),
        Some(([0xC4, 0x8F, 0x0], NZ_TWO)),
        Some(([0xC4, 0x91, 0x0], NZ_TWO)),
        Some(([0xC5, 0x84, 0x0], NZ_TWO)),
        Some(([0xC5, 0x88, 0x0], NZ_TWO)),
        Some(([0xC3, 0xB3, 0x0], NZ_TWO)),
        Some(([0xC3, 0xB4, 0x0], NZ_TWO)),
        Some(([0xC5, 0x91, 0x0], NZ_TWO)),
        Some(([0xC3, 0xB6, 0x0], NZ_TWO)),
        Some(([0xC3, 0xB7, 0x0], NZ_TWO)),
        Some(([0xC5, 0x99, 0x0], NZ_TWO)),
        Some(([0xC5, 0xAF, 0x0], NZ_TWO)),
        Some(([0xC3, 0xBA, 0x0], NZ_TWO)),
        Some(([0xC5, 0xB1, 0x0], NZ_TWO)),
        Some(([0xC3, 0xBC, 0x0], NZ_TWO)),
        Some(([0xC3, 0xBD, 0x0], NZ_TWO)),
        Some(([0xC5, 0xA3, 0x0], NZ_TWO)),
        Some(([0xCB, 0x99, 0x0], NZ_TWO)),
    ];
}
