...
impl CP855 {
    ...
    ///
    /// Allocation-free, so available without the `alloc` feature. CP855
    ...
    /// Encode a single Unicode `char` into its CP855 byte.
    ///
