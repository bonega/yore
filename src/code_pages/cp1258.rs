...
impl DecoderIncomplete for CP1258 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = unsafe {
        [
            ...
            Some(([0xCC, 0x80, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xCC, 0x89, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x93, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0x94, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC6, 0xA0, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC6, 0xAF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCC, 0x83, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xCC, 0x81, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xCC, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xB3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC3, 0xB4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC6, 0xA1, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xC6, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x82, 0xAB], NonZeroU8::new_unchecked(3))),
