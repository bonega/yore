...
impl CP1258 {
    ...
    ///
    /// Allocation-free, so available without the `alloc` feature. CP1258
    ...
    /// Encode a single Unicode `char` into its CP1258 byte.
    ///
...
const DECODE_TABLE: decoder::complete::Table = [
    ...
    Entry::new([0xCC, 0x89, 0x00], 2),
    Entry::new([0xC3, 0x93, 0x00], 2),
    Entry::new([0xC3, 0x94, 0x00], 2),
    Entry::new([0xC6, 0xA0, 0x00], 2),
    ...
    Entry::new([0xC6, 0xAF, 0x00], 2),
    Entry::new([0xCC, 0x83, 0x00], 2),
    ...
    Entry::new([0xCC, 0xA3, 0x00], 2),
    Entry::new([0xC3, 0xB3, 0x00], 2),
    Entry::new([0xC3, 0xB4, 0x00], 2),
    Entry::new([0xC6, 0xA1, 0x00], 2),
    ...
    Entry::new([0xC6, 0xB0, 0x00], 2),
    Entry::new([0xE2, 0x82, 0xAB], 3),
