...
impl DecoderIncomplete for CP869 {
    const DECODE_TABLE: [Option<([u8; 3], NonZeroU8)>; 256] = unsafe {
        [
            ...
            None,
            None,
            Some(([0xCE, 0x86, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            ...
            Some(([0xCE, 0x88, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x80, 0x95], NonZeroU8::new_unchecked(3))),
            Some(([0xCE, 0x89, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x8A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xAA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x8C, 0x0], NonZeroU8::new_unchecked(2))),
            None,
            None,
            Some(([0xCE, 0x8E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xAB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x8F, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xB2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xB3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xAC, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xAD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xAE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xAF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x8A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x90, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x8C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x8D, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x91, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x92, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x93, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x94, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x95, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x96, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x97, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xBD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x98, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x99, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xAB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xBB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x96, 0x91], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x96, 0x92], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x96, 0x93], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x94, 0x82], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x94, 0xA4], NonZeroU8::new_unchecked(3))),
            Some(([0xCE, 0x9A, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x9B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x9C, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x9D, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x95, 0xA3], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0x91], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0x97], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0x9D], NonZeroU8::new_unchecked(3))),
            Some(([0xCE, 0x9E, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x9F, 0x0], NonZeroU8::new_unchecked(2))),
            ...
            Some(([0xCE, 0xA0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x95, 0x9A], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0x94], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0xA9], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0xA6], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0xA0], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0x90], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x95, 0xAC], NonZeroU8::new_unchecked(3))),
            Some(([0xCE, 0xA3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xA9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB2, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB3, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x94, 0x98], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x94, 0x8C], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x96, 0x88], NonZeroU8::new_unchecked(3))),
            Some(([0xE2, 0x96, 0x84], NonZeroU8::new_unchecked(3))),
            Some(([0xCE, 0xB4, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB5, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xE2, 0x96, 0x80], NonZeroU8::new_unchecked(3))),
            Some(([0xCE, 0xB6, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB9, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xBA, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xBB, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xBC, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xBD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xBE, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xBF, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x80, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x81, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x83, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x82, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x84, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x84, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xAD, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xB1, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x85, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x86, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x87, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA7, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x88, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0x85, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xC2, 0xA8, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x89, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x8B, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCE, 0xB0, 0x0], NonZeroU8::new_unchecked(2))),
            Some(([0xCF, 0x8E, 0x0], NonZeroU8::new_unchecked(2))),
